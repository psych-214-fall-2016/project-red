""" py.test test for skeleton.py

Run with:

    py.test test_skeleton.py
"""
...
def test_anatomical_preprocess():
    ...
    #get func outputs
    T1_skull, T1_whole, T1_mask = skeleton.anatomical_preprocess(T1_raw, pop_priors)
...
def test_functional_preprocess():
    ...
    #get func outputs
    EPI_cor, motion_params, EPI_mean, EPI_mask = skeleton.functional_preprocess(EPI_raw)
...
def test_segmentation():
    ...
    #get func outputs
    T1_WMprob, T1_GMprob, T1_CSFprob = skeleton.segmentation(T1_skull)
...
def test_anatomical_reg():
    ...
    #get func outputs
    T1_in_MNI, T1_x2_MNI = skeleton.anatomical_reg(T1_whole, MNI)
...
def test_functional_reg():
    ...
    #get func outputs
    EPI_corrected_in_MNI, EPI_mean_in_MNI, EPI_x2_MNI = skeleton.functional_reg(EPI_cor, EPI_mean, T1_x2_MNI)
